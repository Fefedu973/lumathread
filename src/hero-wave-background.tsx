...
import {
  ...
  type HeroWaveDeformationContext,
  type HeroWaveDeformationOutput,
  ...
  type HeroWaveMusicVisualizerBand,
  type HeroWaveMusicVisualizerConfig,
  type HeroWaveMusicVisualizerSource,
  ...
  type HeroWavePulseDeformer,
  type HeroWaveQualityConfig,
  type HeroWaveQualityPreset,
  type HeroWaveRendererStatus,
  type HeroWaveSampledDeformer,
  type HeroWaveScalarProfile,
  type HeroWaveSceneProps,
  type HeroWaveShapeConfig,
  type HeroWaveSvgViewBox,
  type HeroWaveSvgViewBoxObject,
  type HeroWaveTheme,
  type HeroWaveVelocityInfluence,
} from "./types";
...
type HeroWaveBackgroundCoreProps = HeroWaveBackgroundProps;
...
let cachedGlowProfileTextureData: ReturnType<
  typeof buildGlowProfileTextureData
> | null = null;

function getGlowProfileTextureData() {
...
let cachedPathK0TextureData: Float32Array | null = null;

function getPathK0TextureData() {
...
interface PreparedFilamentFrame {
  settings: Settings;
  visualTime: number;
...
function createFilamentGeometryState(id: string): FilamentGeometryState {
  return {
    id,
    baseKey: -1,
    deformationKey: -1,
